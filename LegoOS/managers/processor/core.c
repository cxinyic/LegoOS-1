...
#if 1
	init_filename = "/data/PowerGraph/graphlab/release/toolkits/graph_analytics/sssp";
	argv_init[0] = init_filename;
	argv_init[1] = "--graph=/data/youtube.adj";
	argv_init[2] = "--source=1";
	argv_init[3] = "--ncpus=8";

// QZ: below is for MonetDB
...
// sth else
	...
	// init_filename = "/data/dcRoutors/MiniPregel/thread/minipregel";
	// argv_init[0] = init_filename;
	// argv_init[1] = "/data/dcRoutors/MiniPregel/minipregel.conf";
