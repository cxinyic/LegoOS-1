cmd_arch/x86/kernel/vmImage.lds := gcc -E -Wp,-MD,arch/x86/kernel/.vmImage.lds.d  -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/4.8/include -I./arch/x86/include -I./arch/x86/include/generated -I./arch/x86/include/generated/uapi  -I./include -I./managers -I./managers -include ./include/lego/kconfig.h -D__KERNEL__    -P -C -Ux86 -D__ASSEMBLY__ -DLINKER_SCRIPT -o arch/x86/kernel/vmImage.lds arch/x86/kernel/vmImage.lds.S
