...
// QZ: MiniPregel
/*
	init_filename = "/bigdisk/MiniPregel/thread/minipregel";
	argv_init[0] = init_filename;
	argv_init[1] = "/bigdisk/MiniPregel/minipregel.conf";
	// argv_init[2] = "1";
//        argv_init[0] = init_filename; 
*/
	init_filename = "/bigdisk/dcRoutors/remote_aggregate/agg";
	argv_init[0] = init_filename;
	argv_init[1] = "/bigdisk/data/lineitem.tbl";
#endif
